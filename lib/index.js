...
function getHttpOptionsFromUrl(inputUrl) {
...
function makeRequest(opts,contentBody,sslOptions,jsonParser,callback) {
    ...
    new Promise((resolve,reject)=>{
        ...
        if (response.code === 503 ) { // https://github.com/prestodb/presto/wiki/HTTP-Protocol "If the response is an HTTP 503, sleep 50-100ms and try again"
            ...
            return callback(new prestoError('invalid response code 123123:', response));
        }
    },(error)=>{
...
class Statement extends Readable {
    ...
    _run() {
        ...
        const requestOpts = getHttpOptionsFromUrl(this[s_nextUri]); //{ path: this[s_nextUri] };
        if(this[s_session]) {
            ...
            */
            ...
            if(data.nextUri) {
                ...
                if(this.fetchInfo && data.infoUri) {
                    ...
                    this.client[s_request](getHttpOptionsFromUrl(data.infoUri)).then(({ data: info }) => {
